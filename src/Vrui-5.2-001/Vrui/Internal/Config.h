...
#define VRUI_INTERNAL_CONFIG_SYSCONFIGDIR "/usr/local/etc/Vrui-5.2"
#define VRUI_INTERNAL_CONFIG_HAVE_USERCONFIGFILE 1
#define VRUI_INTERNAL_CONFIG_USERCONFIGDIR ".config/Vrui-5.2"
#define VRUI_INTERNAL_CONFIG_APPCONFIGDIR "Applications"
#define VRUI_INTERNAL_CONFIG_DEFAULTROOTSECTION "Desktop"

#define VRUI_INTERNAL_CONFIG_VERSION 5002001
#define VRUI_INTERNAL_CONFIG_ETCDIR "/usr/local/etc/Vrui-5.2"
#define VRUI_INTERNAL_CONFIG_SHAREDIR "/usr/local/share/Vrui-5.2"
